      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex w-full gap-3 sm:w-auto">
          ...
          <button
            ...
            className="btn-luxe inline-flex h-11 shrink-0 items-center justify-center rounded-full px-6 text-[11px] font-medium tracking-[0.24em] transition-colors hover:opacity-95 disabled:opacity-50"
          >
            AJOUTER
          </button>
        </div>
